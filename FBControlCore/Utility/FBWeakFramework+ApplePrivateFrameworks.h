 ...
 */
@property (class, nonnull, nonatomic, readonly, strong) FBWeakFramework *CoreSimulator;
 ...
 */
@property (class, nonnull, nonatomic, readonly, strong) FBWeakFramework *SimulatorKit;
 ...
 */
@property (class, nonnull, nonatomic, readonly, strong) FBWeakFramework *DTXConnectionServices;
 ...
 */
@property (class, nonnull, nonatomic, readonly, strong) FBWeakFramework *XCTest;
 ...
 */
@property (class, nonnull, nonatomic, readonly, strong) FBWeakFramework *MobileDevice;

/**
 A macOS Private Framework for transforming iOS Accessibility element definitions to their macOS equivalents.
 */
@property (class, nonnull, nonatomic, readonly, strong) FBWeakFramework *AccessibilityPlatformTranslation;
