...
@property (nonatomic, readwrite, strong) FBMutableFuture<NSNull *> *finishedConsumingMutable;
...
@property (nonatomic, readwrite, strong) dispatch_io_t io;
