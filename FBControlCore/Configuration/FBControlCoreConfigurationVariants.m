...
FBDeviceModel const FBDeviceModeliPhone8A = @"iPhone2017-A";
FBDeviceModel const FBDeviceModeliPhone8PlusB = @"iPhone2017-B";
FBDeviceModel const FBDeviceModeliPhoneXC = @"iPhone2017-C";
...
FBOSVersionName const FBOSVersionNameiOS_13_2_1 = @"iOS 13.2.1";
FBOSVersionName const FBOSVersionNameiOS_13_3 = @"iOS 13.3";
FBOSVersionName const FBOSVersionNameiOS_13_3_1 = @"iOS 13.3.1";
...
+ (NSArray<FBDeviceType *> *)deviceConfigurations
{
  ...
  dispatch_once(&onceToken, ^{
    deviceConfigurations = @[
      [FBDeviceType iPhoneWithModel:FBDeviceModeliPhone8A productTypes:@[@"iPhone10,1", @"iPhone10,4"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType iPhoneWithModel:FBDeviceModeliPhone8PlusB productTypes:@[@"iPhone10,2", @"iPhone10,5"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType iPhoneWithModel:FBDeviceModeliPhoneXC productTypes:@[@"iPhone10,3", @"iPhone10,6"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType iPadWithModel:FBDeviceModeliPadPro_9_7_Inch_2ndGeneration productTypes:@[@"iPad6,4"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      ...
      [FBDeviceType iPhoneWithModel:FBDeviceModeliPhone7 productTypes:@[@"iPhone9,1", @"iPhone9,3"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      ...
      [FBDeviceType watchWithModel:FBDeviceModelAppleWatchSeries5_40mm productTypes:@[@"Watch5,1", @"Watch5,3"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType watchWithModel:FBDeviceModelAppleWatchSeries5_44mm productTypes:@[@"Watch5,2", @"Watch5,4"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType watchWithModel:FBDeviceModelAppleWatchSE_40mm productTypes:@[@"Watch5,9", @"Watch5,11"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType watchWithModel:FBDeviceModelAppleWatchSE_44mm productTypes:@[@"Watch5,10", @"Watch5,12"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType watchWithModel:FBDeviceModelAppleWatchSeries6_40mm productTypes:@[@"Watch6,1", @"Watch6,3"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
      [FBDeviceType watchWithModel:FBDeviceModelAppleWatchSeries6_44mm productTypes:@[@"Watch6,2", @"Watch6,4"] deviceArchitecture:FBArchitectureArm64 simulatorArchitecture:FBArchitectureX86_64],
    ];
  });
...
+ (NSArray<FBOSVersion *> *)OSConfigurations
{
  ...
  dispatch_once(&onceToken, ^{
    OSConfigurations = @[
      ...
      [FBOSVersion iOSWithName:FBOSVersionNameiOS_13_2_1],
      [FBOSVersion iOSWithName:FBOSVersionNameiOS_13_3],
      [FBOSVersion iOSWithName:FBOSVersionNameiOS_13_3_1],
      ...
      [FBOSVersion watchOSWithName:FBOSVersionNamewatchOS_4_3],
      ...
      [FBOSVersion watchOSWithName:FBOSVersionNamewatchOS_5_3],
      [FBOSVersion watchOSWithName:FBOSVersionNamewatchOS_6_0],
      [FBOSVersion watchOSWithName:FBOSVersionNamewatchOS_6_1],
      [FBOSVersion watchOSWithName:FBOSVersionNamewatchOS_6_2],
      [FBOSVersion watchOSWithName:FBOSVersionNamewatchOS_7_0],
    ];
  });
