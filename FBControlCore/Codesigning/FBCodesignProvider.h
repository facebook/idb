 ...
 */
+ (nonnull instancetype)codeSignCommandWithIdentityName:(nonnull NSString *)identityName logger:(nullable id<FBControlCoreLogger>)logger;
 ...
 */
+ (nonnull instancetype)codeSignCommandWithAdHocIdentityWithLogger:(nullable id<FBControlCoreLogger>)logger;
 ...
 */
@property (nonnull, nonatomic, readonly, copy) NSString *identityName;
 ...
 */
- (nonnull FBFuture<NSNull *> *)signBundleAtPath:(nonnull NSString *)bundlePath;
...
/**
 ...
 @return A future that resolves when the bundle has been signed.
 */
- (nonnull FBFuture<NSNull *> *)recursivelySignBundleAtPath:(nonnull NSString *)bundlePath;
 ...
 */
- (nonnull FBFuture<NSString *> *)cdHashForBundleAtPath:(nonnull NSString *)bundlePath;
