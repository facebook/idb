...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration.defaultConfiguration withDeviceModel:FBDeviceModeliPhone7] withOSNamed:FBOSVersionNameiOS_10_0];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration.defaultConfiguration withDeviceModel:FBDeviceModeliPadPro] withOSNamed:FBOSVersionNameiOS_10_0];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration.defaultConfiguration withDeviceModel:FBDeviceModelAppleWatchSeries2_42mm] withOSNamed:FBOSVersionNamewatchOS_3_2];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration.defaultConfiguration withDeviceModel:FBDeviceModelAppleTV] withOSNamed:FBOSVersionNametvOS_10_0];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration.defaultConfiguration withOSNamed:FBOSVersionNametvOS_10_0] withDeviceModel:FBDeviceModeliPhone6];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration.defaultConfiguration withOSNamed:FBOSVersionNameiOS_10_0] withDeviceModel:@"FooPad"];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration.defaultConfiguration withDeviceModel:FBDeviceModeliPhone7] withOSNamed:@"FooOS"];
  XCTAssertEqualObjects(configuration.device.model, FBDeviceModeliPhone7);
