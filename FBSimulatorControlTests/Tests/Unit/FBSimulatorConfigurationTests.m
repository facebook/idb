...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration withDeviceNamed:FBDeviceModeliPhone7] withOSNamed:FBOSVersionNameiOS_10_0];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration withDeviceNamed:FBDeviceModeliPadPro] withOSNamed:FBOSVersionNameiOS_10_0];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration withDeviceNamed:FBDeviceModelAppleWatchSeries2_42mm] withOSNamed:FBOSVersionNamewatchOS_3_2];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration withDeviceNamed:FBDeviceModelAppleTV1080p] withOSNamed:FBOSVersionNametvOS_10_0];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration withOSNamed:FBOSVersionNametvOS_10_0] withDeviceNamed:FBDeviceModeliPhone6];
...
{
  FBSimulatorConfiguration *configuration = [[FBSimulatorConfiguration withDeviceNamed:FBDeviceModeliPhone7] withOSNamed:@"FooOS"];
  XCTAssertEqualObjects(configuration.device.model, FBDeviceModeliPhone7);
