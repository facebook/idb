...
final class SimulatorSetTests: SimulatorSetTestCase {
  ...
  func testInflatesSimulators() {
    createSet(withExistingSimDeviceSpecs: [
      ["name": "iPhone 5", "state": TargetState.creating.rawValue],
      ["name": "iPhone 5", "state": TargetState.shutdown.rawValue],
      ["name": "iPhone 5", "state": TargetState.booted.rawValue],
      ["name": "iPhone 6s", "state": TargetState.shuttingDown.rawValue],
      ["name": "iPad 2", "family": 2, "state": TargetState.booted.rawValue],
      ["name": "iPad Air", "family": 2, "state": TargetState.booted.rawValue],
      ["name": "iPad Air 2", "family": 2, "state": TargetState.creating.rawValue],
      ["name": "iPhone 5", "state": TargetState.shutdown.rawValue, "os": "iOS 10.0"],
    ])
