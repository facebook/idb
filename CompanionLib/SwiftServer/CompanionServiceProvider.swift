...
final class CompanionServiceProvider: Idb_CompanionService.SimpleServiceProtocol, @unchecked Sendable {
  ...
  private func trackedUnaryCall<Request, Response>(_ method: String, request: Request, summarize: ((Response) -> String)? = nil, function: String = #function, file: String = #file, line: Int = #line, column: Int = #column, body: () async throws -> Response) async throws -> Response {
    try await tracked {
      try await telemetry.unaryCall(method, request: request, summarize: summarize) {
        try await scoped(function: function, file: file, line: line, column: column, body)
      }
    }
  }

  private func trackedClientStreaming<Response>(_ method: String, function: String = #function, file: String = #file, line: Int = #line, column: Int = #column, body: () async throws -> Response) async throws -> Response {
    try await tracked {
      try await telemetry.clientStreaming(method) {
        try await scoped(function: function, file: file, line: line, column: column, body)
      }
    }
  }

  private func trackedServerStreaming<Request>(_ method: String, request: Request, function: String = #function, file: String = #file, line: Int = #line, column: Int = #column, body: () async throws -> Void) async throws {
    try await tracked {
      try await telemetry.serverStreaming(method, request: request) {
        try await scoped(function: function, file: file, line: line, column: column, body)
      }
    }
  }

  private func trackedBidiStreaming(_ method: String, function: String = #function, file: String = #file, line: Int = #line, column: Int = #column, body: () async throws -> Void) async throws {
    try await tracked {
      try await telemetry.bidiStreaming(method) {
        try await scoped(function: function, file: file, line: line, column: column, body)
      }
    }
  }
