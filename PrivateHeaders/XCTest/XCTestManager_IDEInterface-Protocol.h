...
@optional // Those methods are not truly optional. They are marked as optional to make compiler happy with dynamic dispatch as me need just few methods implemented.
