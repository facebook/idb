...
+ (id)schemes;
@property (nonatomic, readonly) DTXResourceTracker *resourceTracker; // @synthesize resourceTracker=_tracker;
...
@property (nonatomic, copy) CDUnknownBlockType dataReceivedHandler;
- (void)disconnect;
