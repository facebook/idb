...
@property (nonatomic, retain) NSMutableArray *disconnectSources;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *pairingStateQueue;
@property (nonatomic, weak) SimDeviceSet *deviceSet;
@property (nonatomic, retain) SimDevice *companion;
@property (nonatomic, retain) SimDevice *gizmo;
