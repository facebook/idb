...
+ (id)defaultSetPath;
@property (nonatomic, retain) NSString *defaultCreatedLastDeveloperDir; // @synthesize defaultCreatedLastDeveloperDir=_defaultCreatedLastDeveloperDir;
@property (nonatomic, retain) NSMutableDictionary *defaultCreatedDevices; // @synthesize defaultCreatedDevices=_defaultCreatedDevices;
@property (nonatomic, retain) NSMutableDictionary *hostDeathSourceByUDID; // @synthesize hostDeathSourceByUDID=_hostDeathSourceByUDID;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *hostDeathQueue; // @synthesize hostDeathQueue=_hostDeathQueue;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *deviceDeletionQueue; // @synthesize deviceDeletionQueue=_deviceDeletionQueue;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *defaultCreatedDevicesQueue; // @synthesize defaultCreatedDevicesQueue=_defaultCreatedDevicesQueue;
@property (nonatomic, retain) SimDeviceNotificationManager *notificationManager; // @synthesize notificationManager=_notificationManager;
@property (nonatomic, retain) SimServiceContext *serviceContext; // @synthesize serviceContext=_serviceContext;
@property (nonatomic, retain) NSMutableDictionary *deviceDeletionCountByUDID; // @synthesize deviceDeletionCountByUDID=_deviceDeletionCountByUDID;
@property (nonatomic, retain) NSMutableDictionary *devicePairsNotificationRegIDs; // @synthesize devicePairsNotificationRegIDs=_devicePairsNotificationRegIDs;
@property (nonatomic, retain) NSMutableDictionary *_devicePairsByUUID; // @synthesize _devicePairsByUUID=__devicePairsByUUID;
@property (nonatomic, retain) NSMutableDictionary *devicesNotificationRegIDs; // @synthesize devicesNotificationRegIDs=_devicesNotificationRegIDs;
@property (nonatomic, retain) NSMutableDictionary *_devicesByUDID; // @synthesize _devicesByUDID=__devicesByUDID;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *devicesQueue; // @synthesize devicesQueue=_devicesQueue;
@property (nonatomic, retain) NSObject<OS_dispatch_queue> *deviceNotificationQueue; // @synthesize deviceNotificationQueue=_deviceNotificationQueue;
@property (nonatomic, copy) NSString *setPath; // @synthesize setPath=_setPath;
...
@property (nonatomic, readonly) NSArray *availableDevicePairs;
@property (nonatomic, readonly) NSArray *devicePairs;
@property (nonatomic, readonly) NSDictionary *devicePairsByUUID;
@property (nonatomic, readonly) NSArray *availableDevices;
@property (nonatomic, readonly) NSArray *devices;
- (BOOL)isDeviceInSet:(id)arg1;
@property (nonatomic, readonly) NSDictionary *devicesByUDID;
- (id)description;
- (void)saveToDisk;
