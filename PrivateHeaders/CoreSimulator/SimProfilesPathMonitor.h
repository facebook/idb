...
@property (nonatomic, retain) NSMutableDictionary *monitoredPathsDict;
@property (nonatomic, retain) NSMutableArray *leafMonitorSources;
...
- (void)fence;
@property (nonatomic, readonly, copy) NSArray *monitoredPaths;
