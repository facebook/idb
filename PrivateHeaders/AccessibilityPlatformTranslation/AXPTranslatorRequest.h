...
@property (nonatomic, retain) NSDictionary *parameters; // @synthesize parameters=_parameters;
...
@property (nonatomic, retain) AXPTranslationObject *translation; // @synthesize translation=_translation;
- (id)description;
