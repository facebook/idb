...
+ (void)initialize;
@property (nonatomic, copy) NSString *remoteDebugDescription; // @synthesize remoteDebugDescription=_remoteDebugDescription;
@property (nonatomic, copy) CDUnknownBlockType remoteDescriptionBlock; // @synthesize remoteDescriptionBlock=_remoteDescriptionBlock;
@property (nonatomic) BOOL didPopuldateAppInfo; // @synthesize didPopuldateAppInfo=_didPopuldateAppInfo;
@property (nonatomic, copy) NSData *rawElementData; // @synthesize rawElementData=_rawElementData;
@property (nonatomic, copy) NSString *bridgeDelegateToken; // @synthesize bridgeDelegateToken=_bridgeDelegateToken;
