...
class TestParser(TestCase):
    ...
    async def test_launch_with_udid(self):
    ...
    async def test_connect_with_host_and_port(self):
    ...
    async def test_connect_with_host_and_port_and_grpc_port(self):
        self.client_mock().connect = AsyncMock()
        host = "someHost"
        port = 1234
        grpc_port = 1235
    ...
    async def test_connect_with_udid(self):
        self.client_mock().connect = AsyncMock()
        udid = "AAAA-AAAA"
    ...
    async def test_disconnect_with_host_and_port(self):
    ...
    async def test_file_mkdir_colon(self):
        self.client_mock().mkdir = AsyncMock()
    ...
    async def test_file_rmpath_flag(self):
    ...
    async def test_file_rmpath_flag_multiple(self):
        self.client_mock().rm = AsyncMock()
        srcs = ["pathA", "pathB"]
        bundle_id = "com.bundle.id"
    ...
    async def test_file_rmpath_colon(self):
        self.client_mock().rm = AsyncMock()
    ...
    async def test_file_listpath_flag(self):
    ...
    async def test_file_listpath_colon(self):
        self.client_mock().ls = AsyncMock(return_value=[])
    ...
    async def test_file_move_flag(self):
    ...
    async def test_file_move_flag_multiple(self):
        self.client_mock().mv = AsyncMock(return_value=[])
        srcs = ["src1", "src2"]
        dst = "b"
        bundle_id = "com.bundle.id"
    ...
    async def test_file_move_colon(self):
        self.client_mock().mv = AsyncMock(return_value=[])
        src = "a"
    ...
    async def test_file_push_single_flag(self):
    ...
    async def test_file_push_multi_flag(self):
    ...
    async def test_file_push_single_colon(self):
        self.client_mock().push = AsyncMock(return_value=[])
        src = "Library/myFile.txt"
    ...
    async def test_file_push_multi_colon(self):
        self.client_mock().push = AsyncMock(return_value=[])
        src1 = "Library/myFile.txt"
        src2 = "Library/myFile2.txt"
    ...
    async def test_push_deprecated(self):
        self.client_mock().push = AsyncMock(return_value=[])
    ...
    async def test_pull_deprecated(self):
        self.client_mock().pull = AsyncMock(return_value=[])
        bundle_id = "com.myapp"
        src = "Library/myFile.txt"
        dest = "someOutputDir"
    ...
    async def test_xctest_install(self):
    ...
    async def test_xctest_run_app(self):
        mock = AsyncMock()
        mock.return_value = []
        with patch(
    ...
    async def test_xctest_run_ui(self):
        mock = AsyncMock()
        mock.return_value = []
        with patch(
    ...
    async def test_xctest_run_logic(self):
        mock = AsyncMock()
        mock.return_value = []
        with patch(
    ...
    async def test_xctest_list(self):
    ...
    async def test_xctest_list_bundles(self):
    ...
    async def test_log_arguments(self):
        mock = AsyncMock()
        with patch("idb.cli.commands.log.LogCommand._run_impl", new=mock, create=True):
    ...
    async def test_clear_keychain(self):
    ...
    async def test_swipe_with_delta(self):
    ...
    async def test_swipe_without_delta(self):
        self.client_mock().swipe = AsyncMock(return_value=[])
    ...
    async def test_contacts_update(self):
    ...
    async def test_accessibility_info_all(self):
    ...
    async def test_crash_list_with_predicate(self):
        self.client_mock().crash_list = AsyncMock(return_value=[])
    ...
    async def test_crash_show(self):
    ...
    async def test_crash_delete_all(self):
    ...
    async def test_crash_delete_with_predicate(self):
        self.client_mock().crash_delete = AsyncMock(return_value=[])
    ...
    async def test_crash_delete_with_name(self):
        self.client_mock().crash_delete = AsyncMock(return_value=[])
    ...
    async def test_instruments_with_post_args(self):
        self.client_mock().run_instruments = AsyncMock()
    ...
    async def test_instruments_with_app_args(self):
        self.client_mock().run_instruments = AsyncMock()
        template_name = "System Trace"
        trace_path = template_name + ".trace"
        await cli_main(
    ...
    async def test_debugserver_start(self):
    ...
    async def test_debugserver_stop(self):
    ...
    async def test_debugserver_status(self):
