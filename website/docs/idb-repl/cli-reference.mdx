...
Each of `app` / `simulator` / `test` takes an optional trailing `code` argument — a single string of Swift. With code supplied it runs once, prints, and exits; with no code it starts the interactive REPL (**experimental** — see [Interactive commands](#interactive-commands)).
