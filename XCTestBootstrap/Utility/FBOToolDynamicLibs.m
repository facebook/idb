...
{
  return [[FBOToolOperation listSanitiserDylibsRequiredByBundle:bundlePath onQueue:queue] onQueue:queue
                                                                                              map:^id _Nonnull (NSArray<NSString *> * _Nonnull libsList) {
                                                                                                ...
                                                                                                NSArray<NSURL *> *bundleLibs = [self filesInDirectory:[NSURL fileURLWithPath:bundleFrameworksFolder]
                                                                                                                                                error:&error];
