...
typedef struct {
  ...
  int (*SecureInstallApplicationBundle)(AMDeviceRef device, CFURLRef arg2, CFDictionaryRef arg3, _Nullable AMDeviceProgressCallback callback, void *_Nullable context);
