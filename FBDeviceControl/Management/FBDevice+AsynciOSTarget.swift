...
// MARK: - FBDevice+AsyncXCTraceRecordCommands

extension FBDevice: AsyncXCTraceRecordCommands {
...
// MARK: - FBDevice+AsyncInstrumentsCommands

extension FBDevice: AsyncInstrumentsCommands {
