...
let validActions: [([String], Action)] = [
  ...
  (["launch_xctest", "/usr/bin", "com.foo.bar", "--foo", "-b", "-a", "-r"], Action.launchXCTest(FBTestLaunchConfiguration().withApplicationLaunchConfiguration(FBApplicationLaunchConfiguration(bundleID: "com.foo.bar", bundleName: nil, arguments: ["--foo", "-b", "-a", "-r"], environment: [:], options: FBProcessLaunchOptions())).withTestBundlePath("/usr/bin"))),
  (["launch_xctest", "/usr/bin", "com.foo.bar"], Action.launchXCTest(FBTestLaunchConfiguration().withApplicationLaunchConfiguration(FBApplicationLaunchConfiguration(bundleID: "com.foo.bar", bundleName: nil, arguments: [], environment: [:], options: FBProcessLaunchOptions())).withTestBundlePath("/usr/bin"))),
  (["launch_xctest", "/usr/bin", Fixtures.application.path], Action.launchXCTest(FBTestLaunchConfiguration().withApplicationLaunchConfiguration(FBApplicationLaunchConfiguration(bundleID: Fixtures.application.bundleID, bundleName: nil, arguments: [], environment: [:], options: FBProcessLaunchOptions())).withTestBundlePath("/usr/bin").withTestHostPath(Fixtures.application.path))),
  (["launch_xctest", "--test-timeout", "900", "/usr/bin", Fixtures.application.path], Action.launchXCTest(FBTestLaunchConfiguration().withApplicationLaunchConfiguration(FBApplicationLaunchConfiguration(bundleID: Fixtures.application.bundleID, bundleName: nil, arguments: [], environment: [:], options: FBProcessLaunchOptions())).withTestBundlePath("/usr/bin").withTestHostPath(Fixtures.application.path).withTimeout(900))),
  (["list"], Action.list),
