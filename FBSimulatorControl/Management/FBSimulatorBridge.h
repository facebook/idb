 ...
 */
+ (nonnull FBFuture<FBSimulatorBridge *> *)bridgeForSimulator:(nonnull FBSimulator *)simulator;
 ...
 */
- (nonnull FBFuture<NSNull *> *)setLocationWithLatitude:(double)latitude longitude:(double)longitude;
 ...
 */
- (nonnull FBFuture<NSNull *> *)enableAccessibility;
 ...
 */
- (nonnull FBFuture<NSArray<NSDictionary<NSString *, id> *> *> *)accessibilityElements;
 ...
 */
- (nonnull FBFuture<NSDictionary<NSString *, id> *> *)accessibilityElementAtPoint:(CGPoint)point;
