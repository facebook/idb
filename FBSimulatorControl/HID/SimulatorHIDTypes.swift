...
/// `SimulatorHIDEvent` dispatch share these; they are intentionally independent of any one
...
/// bottom edge.
public enum SimulatorHIDEdge: UInt32, Sendable, CaseIterable {
  case none = 0
  case top = 1
  case left = 2
  case bottom = 3
...
public enum SimulatorHIDRemoteButton: Int32, Sendable, CaseIterable {
  case up = 1
  case down = 2
  case left = 3
  case right = 4
...
public struct SimulatorTrackpadPoint: Equatable, Hashable, Sendable {
