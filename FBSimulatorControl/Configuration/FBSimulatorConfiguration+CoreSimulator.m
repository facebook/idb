...
+ (FBOSVersion *)newestAvailableOSForDevice:(id<FBControlCoreConfiguration_Device>)device
{
...
+ (FBOSVersion *)oldestAvailableOSForDevice:(id<FBControlCoreConfiguration_Device>)device
{
