...
/// `AXWireContractTests` pins host-side and the `SimulatorFrameworkBridge` tests pin guest-side.
///
...
/// `AXBridgeFrontmostMethod`, and the modal kinds are `AccessibilityModalInfo.Kind`
/// (`system`/`app`).
enum AXWire {
