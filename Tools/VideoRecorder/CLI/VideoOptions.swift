...
struct SimulatorOptions: ParsableArguments {
  ...
  @MainActor
  func simulator(logger: any ControlCoreLogger) throws -> Simulator {
    let configuration = SimulatorControlConfiguration(deviceSetPath: set, logger: logger)
...
struct VideoOptions: ParsableArguments {
  ...
  @MainActor
  func composition(simulator: Simulator, logger: any ControlCoreLogger) throws -> (VideoStreamEdgeInsets, OverlayRenderer, [(position: String, height: Int, mode: BarMode)]) {
